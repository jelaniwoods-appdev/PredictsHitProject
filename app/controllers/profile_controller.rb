class ProfileController < ApplicationController
  ...
  def update_profile
    ...
    if updated_profile.valid?
      ...
      redirect_to("/profile/manage/" + @user_id, { :alert => "Your profile was not updated. Username invalid or already taken."}) #Will need to update to make more clear and be dynamic for issue once other options to change/other failure points.
    end
  end
